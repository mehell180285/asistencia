        ...
        <div class="row h-100">
            <div class="col-lg-5 col-12">
                <div id="auth-left">
                    ...
                    <p class="auth-subtitle mb-4">Inicie sesión en su cuenta</p>

                    <form action="{{ route('login') }}" method="POST">
                        @csrf
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" id="username" name="username" class="form-control form-control-xl" value="{{old('username')}}" placeholder="Usuario" autocomplete="username">
                            <div class="form-control-icon">
                                <i class="bi bi-person"></i>
                            </div>
                            @if ($errors->has('username'))
                                <div class="alert alert-light-danger color-danger mt-2">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="password" id="password" name="password" class="form-control form-control-xl" value="{{old('password')}}" placeholder="Contraseña">
                            <div class="form-control-icon">
                        ...
                        <button class="btn btn-primary btn-block btn-lg shadow-lg mt-4">Ingresar</button>
                    </form>
